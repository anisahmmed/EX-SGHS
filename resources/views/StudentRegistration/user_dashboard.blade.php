...
<?php  
$date = explode("-", $loggeduserinfo->DoB);
?>
<head>
    <style>
        body{
...
<div class="container rounded bg-white mt-5 mb-5" id="Profile">
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="{{asset('Uploads/'.$loggeduserinfo->FilePath)}}"><span class="font-weight-bold">{{ $loggeduserinfo->FullName }}</span><span class="text-black-50">{{ $loggeduserinfo->Email }}</span><span> </span><span class="text-black-50">Member ID : {{ $loggeduserinfo->UserId }}</span><span> </span>
            ...
            @elseif($loggeduserinfo->br_status == 2)
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <hr>
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Batch : </label> <span>{{ $loggeduserinfo->Batch }}</span></div><br/>
                    <div class="col-md-12"><label class="labels">Name : </label> <span>{{ $loggeduserinfo->FullName }}</span></div>
                    <div class="col-md-12"><label class="labels">Mobile Number :&nbsp;</label><span>{{ $loggeduserinfo->PhoneNumber }}</span></div>
                </div>
                <div class="row mt-3">
                   
                    <div class="col-md-12"><label class="labels">Present Address : &nbsp;</label><span>{{ $loggeduserinfo->PresentAddress }}</span></div><br><br>  
                    <div class="col-md-12"><label class="labels">Permanent Address : &nbsp;</label><span>{{ $loggeduserinfo->ParmanentAddress }}</span></div><br><br>
                    <div class="col-md-12"><label class="labels">Profession : &nbsp;</label><span>{{ $loggeduserinfo->Profession }}</span></div><br><br>
                    <div class="col-md-12"><label class="labels">Profession Details : &nbsp;</label><span>{{ $loggeduserinfo->ProfessionDetails }}</span></div><br><br>
                    <div class="col-md-12"><label class="labels">Blood Group : &nbsp;</label><span>{{ $loggeduserinfo->BloodGroup }}</span></div><br><br>
                    <div class="col-md-12"><label class="labels">Date of Birth : &nbsp;</label><span>{{ $loggeduserinfo->DoB }}</span></div><br><br>
                    <div class="col-md-12"><label class="labels">Product : &nbsp;</label><span>{{ $loggeduserinfo->Product }}</span></div><br><br>
                    <div class="col-md-12"><label class="labels">Size : &nbsp;</label><span>{{ $loggeduserinfo->Size }}</span></div><br><br>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <!--<div class="col-md-12"><label class="labels">Batch : &nbsp;</label><span>{{ $loggeduserinfo->Batch }}</span></div> <br>-->
                <!--<div class="col-md-12"><label class="labels">Amount : &nbsp;</label><span>{{ $loggeduserinfo->Amount }}</span></div><br>-->
                <!--<div class="col-md-12"><label class="labels">Donation : &nbsp;</label><span>{{ $loggeduserinfo->AmountExt }}</span></div>-->
                <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{{ date('d-m-Y h:i A', strtotime($loggeduserinfo->created_at)) }}</td>
                      <td>{{ $loggeduserinfo->Amount }}</td>
                    </tr>
                    <tr>
                      <td>Donation</td>
                      <td>{{ date('d-m-Y h:i A', strtotime($loggeduserinfo->created_at)) }}</td>
                      <td>{{ $loggeduserinfo->AmountExt }}</td>
                    </tr>
                  </tbody>
                </table>
            </div>
...
<form class="needs-validation" id="my_form" enctype="multipart/form-data" action="updateStudent" method="post" novalidate>
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="{{asset('Uploads/'.$loggeduserinfo->FilePath)}}" id="FilePath_Span"><span class="font-weight-bold">{{ $loggeduserinfo->FullName }}</span><span class="text-black-50">{{ $loggeduserinfo->Email }}</span></span><span class="text-black-50">Member ID : {{ $loggeduserinfo->UserId }}</span></div>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="Name" value="{{ $loggeduserinfo->FullName }}" id="FullName" name="FullName"></div>
                    <div class="col-md-6"><label class="labels">Mobile Number</label><input readonly type="text" class="form-control" placeholder="enter phone number" value="{{ $loggeduserinfo->PhoneNumber }}" id="PhoneNumber" name="PhoneNumber"></div>
                </div>
                <div class="row mt-3">
                ...
                <select name="shift" class="form-control suk-select-field" id="shift" tabindex="-1" aria-hidden="true" required>
                                    ...
                                    <option value="NotApplicable" <?php if($loggeduserinfo->shift == "NotApplicable") echo 'selected = "selected"'; ?>>Not Applicable</option>
                                    <option value="Morning" <?php if($loggeduserinfo->shift == "Morning") echo 'selected = "selected"'; ?>>Morning</option>
                                    <option value="Day" <?php if($loggeduserinfo->shift == "Day") echo 'selected = "selected"'; ?>>Day</option>
                                    
                                </select><br></div>
                    <div class="col-md-12"><label class="labels">Present Address</label><input type="text" class="form-control" placeholder="enter address line 1" value="{{ $loggeduserinfo->PresentAddress }}" id="PresentAddress" name="PresentAddress"></div>
                    <div class="col-md-12"><label class="labels">Permanent Address</label><input type="text" class="form-control" placeholder="enter address line 2" value="{{ $loggeduserinfo->ParmanentAddress }}" id="ParmanentAddress" name="ParmanentAddress"></div>
                    <div class="col-md-12"><label class="labels">Profession</label><input type="text" class="form-control" placeholder="enter address line 2" value="{{ $loggeduserinfo->Profession }}" id="Profession" name="Profession"></div>
                    <div class="col-md-12"><label class="labels">Profession Details</label><input type="text" class="form-control" placeholder="enter address line 2" value="{{ $loggeduserinfo->ProfessionDetails }}" id="ProfessionDetails" name="ProfessionDetails"></div>
                    ...
                    <select name="BloodGroup" id="BloodGroup" class="form-control" required>
                            ...
                            <option value="A+"<?php if($loggeduserinfo->BloodGroup == "A+") echo 'selected = "selected"'; ?>>A+</option>
                            <option value="A-"<?php if($loggeduserinfo->BloodGroup == "A-") echo 'selected = "selected"'; ?>>A-</option>
                            <option value="B+"<?php if($loggeduserinfo->BloodGroup == "B+") echo 'selected = "selected"'; ?>>B+</option>
                            <option value="B-"<?php if($loggeduserinfo->BloodGroup == "B-") echo 'selected = "selected"'; ?>>B-</option>
                            <option value="O+"<?php if($loggeduserinfo->BloodGroup == "O+") echo 'selected = "selected"'; ?>>O+</option>
                            <option value="O-"<?php if($loggeduserinfo->BloodGroup == "O-") echo 'selected = "selected"'; ?>>O-</option>
                            <option value="AB+"<?php if($loggeduserinfo->BloodGroup == "AB+") echo 'selected = "selected"'; ?>>AB+</option>
                            <option value="AB-"<?php if($loggeduserinfo->BloodGroup == "AB-") echo 'selected = "selected"'; ?>>AB-</option>
                        </select><br>
                    </div>
                    ...
                    <input type="text" class="form-control" placeholder="enter email id" value="{{ $loggeduserinfo->DoB }}" id="DoB" name="DoB" hidden></div>
                    <div class="col-md-12"><label class="labels">Product</label><input readonly type="text" class="form-control" placeholder="education" value="{{ $loggeduserinfo->Product }}" id="Product" name="Product"></div>
                    ...
                    <select name="Size" class="form-control suk-select-field" id="Size" tabindex="-1" aria-hidden="true" required>
                        ...
                        <option value="S" <?php if($loggeduserinfo->Size == "S") echo 'selected = "selected"'; ?>>S (Small)</option>
                        <option value="M" <?php if($loggeduserinfo->Size == "M") echo 'selected = "selected"'; ?>>M (Medium)</option>
                        <option value="L" <?php if($loggeduserinfo->Size == "L") echo 'selected = "selected"'; ?>>L (Large)</option>
                        <option value="XL" <?php if($loggeduserinfo->Size == "XL") echo 'selected = "selected"'; ?>>XL</option>
                        <option value="XXL" <?php if($loggeduserinfo->Size == "XXL") echo 'selected = "selected"'; ?>>XXL</option>
                        <option value="XXXL" <?php if($loggeduserinfo->Size == "XXXL") echo 'selected = "selected"'; ?>>XXXL</option>
                    </select>
                    
                    <!-- <input type="text" class="form-control" placeholder="education" value="{{ $loggeduserinfo->Size }}" id="Size" name="Size"> --></div>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels">Batch</label><input readonly type="text" class="form-control" placeholder="experience" value="{{ $loggeduserinfo->Batch }}" id="Batch" name="Batch"></div> <br>
                <!--<div class="col-md-12"><label class="labels">Amount</label><input readonly type="text" class="form-control" placeholder="additional details" value="{{ $loggeduserinfo->Amount }}" id="Amount" name="Amount"></div><br>-->
                <!--<div class="col-md-12"><label class="labels">Donation</label><input readonly type="text" class="form-control" placeholder="additional details" value="{{ $loggeduserinfo->AmountExt }}" id="AmountExt" name="AmountExt"></div><br>-->
                <div class="col-md-12"><label class="labels">Password</label><input type="text" class="form-control" placeholder="additional details" value="{{ $loggeduserinfo->password }}" id="password" name="password"></div><br>
            </div>
        </div>
    </div>
