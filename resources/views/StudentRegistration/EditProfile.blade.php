                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item active">
                        <a class="nav-link font-weight-bold" href="#">BR Panel</a>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <hr>
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name : </label> <span>{{ $profile->FullName }}</span></div>
                    <div class="col-md-6"><label class="labels">Mobile Number :&nbsp;</label><span>{{ $profile->PhoneNumber }}</span></div>
                </div>
                <div class="row mt-3">
