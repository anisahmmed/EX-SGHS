...
<div class="container">
    ...
    <div class="row row-xs mg-b-25">
        ...
        <h3 class="w-100 mg-b-0 mg-t-5 text-center">Batch Representative List</h3>
        <hr class="w-100" />
        @php
            $sl=1;
        @endphp
        @foreach($all_public_br as $public_br)
        @if($public_br->status == 1 && $public_br->br_status == 1)
        <div class="col-md-8 offset-md-2 col-12">
            <div class="row card-item p-0 mg-b-10 d-flex align-items-center mg-l-0 mg-r-0">
                ...
                <div class="col-7 col-md-7">
                    ...
                    @if($public_br->br_status == 1)
                    <span class="badge badge-dark">Batch Representative</span>
                    @endif
                    </p> 
                </div>
            </div>
