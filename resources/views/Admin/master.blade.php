...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="https://ex-students-sghs.org/old_website/assets/uploads/media-uploader/screenshot-41667242655.png"
    />
  ...
  <body>
    ...
    >
          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="#">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="https://ex-students-sghs.org/old_website/assets/uploads/media-uploader/logo-png1667227905.png"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="{{ asset('Dashboard/assets/images/exsghs.png') }}"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  aria-expanded="false"
                >
                  <img src="/Dashboard/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"/></a>
                <ul
        ...
        <div class="scroll-sidebar">
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
              ...
              <!--    aria-expanded="false"-->
              <!--    ><i class="mdi mdi-view-dashboard"></i-->
              <!--    ><span class="hide-menu">Student Registration Report</span></a-->
              <!--  >-->
              <!--</li>-->
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="{{ route('registration_report') }}"
                  aria-expanded="false"
                  ><i class="mdi mdi-chart-bar"></i
                  ><span class="hide-menu">Registration Report</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="{{ route('student_detail') }}"
                  aria-expanded="false"
                  ><i class="mdi mdi-border-inside"></i
                  ><span class="hide-menu">BR Selection</span></a
                >
              </li>
      ...
      @yield('content')
        ...
        <footer class="footer text-center">
          All Rights Reserved by EX-SGHS. Designed and Developed by
          <a href="https://metasoftinfo.com/">Metasoft Info</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="/Dashboard/dist/js/pages/chart/chart-page-init.js"></script>
    <script>
