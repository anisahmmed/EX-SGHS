...
@section('content')
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="bg-success text-white text-center">BR</td>
                @elseif($registration_info->br_status == 2)
                <td class="bg-warning text-white text-center">Admin & Moderator</td>
                @else
                <td>Member</td>
                @endif
                ...
                @if($registration_info->br_status == 1)
                <td>
                    <a href="{{ url('/edit-br-status') }}/{{ $registration_info->id }}" class="btn btn-info" >Edit BR</a>
                </td>
                @elseif($registration_info->br_status == 2)
                <td>
                    <a href="{{ url('/edit-br-status') }}/{{ $registration_info->id }}" class="btn btn-warning" >Edit Admin</a>
                </td>
                @else
                <td>
